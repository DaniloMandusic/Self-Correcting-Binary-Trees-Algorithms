...
int main() {
    ...
    myData data0 = *new myData(0);

    myData data = *new myData(3);

    myData data1 = *new myData(4);

    myData data2 = *new myData(5);

    myData data3 = *new myData(6);

    myData data4 = *new myData(7);
    myData data5 = *new myData(8);
    myData data6 = *new myData(9);
    myData data7 = *new myData(10);
    myData data8 = *new myData(11);
